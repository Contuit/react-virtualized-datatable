...
it('should call onPageChanged when a new page is clicked', function () {
  var pageChangeMock = jest.fn();
  var wrapper = (0, _enzyme.mount)(_react2.default.createElement(_DataGrid2.default, {
    items: items,
    totalItemCount: 10,
    columns: columns
...
it('should call onPageChanged when next is clicked', function () {
  var pageChangeMock = jest.fn();
  var wrapper = (0, _enzyme.mount)(_react2.default.createElement(_DataGrid2.default, {
    items: items,
    totalItemCount: 10,
...
it('should call onPageChanged when previous is clicked', function () {
  var pageChangeMock = jest.fn();
  var wrapper = (0, _enzyme.mount)(_react2.default.createElement(_DataGrid2.default, {
    items: items,
    totalItemCount: 10,
