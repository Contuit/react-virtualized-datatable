...
var DataGrid = function (_Component) {
  ...
  _createClass(DataGrid, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (JSON.stringify(nextProps.items) !== JSON.stringify(this.props.items) || JSON.stringify(nextProps.columns) !== JSON.stringify(this.props.columns)) {
        console.log('here??');
